...
The \textit{LeapfrogJoin} interface has five methods shown in~\cref{table:lftj-interfaces}, with their required asymptopical
performance.
...
Therfore, it points to the same offset as the entry for $2$.
