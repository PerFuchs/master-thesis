...
It scales as good or better for most levels of parallelism for the 5-clique query up to 96 workers on the LiveJournal dataset
and half as good to as good on the Orkut dataset.
