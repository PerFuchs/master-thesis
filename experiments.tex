...
Setup time includes the sorting, materialization of the data and copying the results of our join from a Scala \texttt{Array} into the \texttt{UnsafeInternalRow} format
...
% TODO can I write that this is inline with former research?
