...
\begin{figure}
    \centering
    \includesvg{svg/seq-bar-ama0302}
...
\begin{figure}
    \centering
    \includesvg{svg/seq-bar-ama0601}
...
\begin{figure}
    \centering
    \includesvg{svg/seq-bar-snb-sf1}
...
%    \subfloat[]{
%    \includesvg[width=0.4\textwidth]{svg/lftj-graphWCOJ-twitter}
%    \includesvg[width=0.2\textwidth]{svg/lftj-graphWCOJ-twitter-long}
%    }
