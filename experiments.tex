...
Our sequential implementation of Leapfrog Triejoin (see~\cref{ssec:seq}), called \texttt{seq} and Spark's two different binary join
...
\begin{table}[]
    ...
    \begin{tabular}{lllll} \toprule
        ...
        \textbf{SNB}     & sf1     &          &       & \cite{snb}      \\
        \textbf{Amazon}  & 0302    &          &       & \cite{snapnets} \\
        & 0601    &          &       & \cite{snapnets} \\
        \textbf{Twitter} & sc-d    &          &       & \cite{snapnets} \\
...
Generally, we see that for \texttt{n-clique} patterns the speedup over Spark.
