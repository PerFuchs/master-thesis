...
The 4-clique sees a speedup which is higher than for 3-clique but lower than 5-clique.
% TODO spark overhead
...
Our explanation is that 4- and 5-clique result in higher skew even with \textit{work-stealing}.
...
first binding.
In this experiment, we see that this job size is not fine-grained enough for bigger queries.
We address this issue in~\cref{subsubsec:work-stealing.}
