...
For \texttt{seq}, we the time, it takes to run the join, excluding setup time.
...
We ran Spark without code generation for comparision on the \texttt{Amazon-0302} dataset for the triangle
...
\subsection{Scaling of \textit{GraphWCOJ}} \label{subsec:scaling-graphWCOJ}
