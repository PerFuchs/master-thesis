...
Each machine runs one executor which uses 1 fourth of the available cores.
...
We analyse the results by query.
...
This is unexpected because in all executors receive the same workload in each repetition.
...
The internal executor skew is similar to the skew displayed for our local mode experiment in~\cref{table:distributed-skew-livej}.
