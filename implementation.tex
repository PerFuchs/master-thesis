...
This solution is sufficient because there are only a few of such vertices in real-world graphs. % TODO add to graph analysis chapter?
...
The outcomes can be seen in \cref{fig:wcoj-vs-graphWCOJ} which demonstrates a up to 2.6 over a column based \textsc{LFTJ}.  % NUMBER
...
\begin{figure}
    \includegraphics[widht=\textwidth]{wcoj-vs-graph-wcoj.png}
