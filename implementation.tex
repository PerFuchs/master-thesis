...
this new version and a column based \textit{TrieIterator} (as described in~\cref{sec:trie-iterator}) and conclude with an experiment
demonstrating the power of this optimization.
