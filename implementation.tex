...
The listings contains two important functions: the initialization function from line~\ref{line:lftjInitStart} to line~\ref{line:lftjInitEnd} % LINE
...
However, the method can be improved by avoiding to sort the \textit{TrieIterators} (line TODO).  % LINE
