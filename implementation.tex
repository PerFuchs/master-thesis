...
First, we analysis the intersection workload in terms of input sizes and size after intersection to confirm our hypothesis
...
\begin{figure}[!tbp]
  \centering
  \subfloat[Total intersection]{\includegraphics[width=0.3\textwidth]{intersections/total.png}
   \hfill
   \subfloat[Largest intersection including smallest iterator]{\includegraphics[width=0.3\textwidth]{intersections/smallest-biggest.png}
   \hfill
   \subfloat[Smallest iterator]{\includegraphics[width=0.3\textwidth]{intersections/smallest.png}
