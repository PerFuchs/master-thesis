...
\begin{figure}
    \includesvg[width=0.2\textwidth]{triangle}
...
\begin{figure}
    \includesvg[width=0.2\textwidth]{diamond}
...
As explained in~\cref{figure:graph-patter-example-bank-fraud}, cycles can be used to detect bank fraud.
...
% TODO equation needs to be shifted to the chapter before
\begin{equation}
