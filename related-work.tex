...
\subsubsetion{Theoretical guarantees}
\textit{BigJoin} guarantues computational and communication worst-case optimality.
...
The extensions \textit{BigJoin-S} additionally gives work-balance and low memory usage in $\matcal{O} (\frac{IN}{w})$.
